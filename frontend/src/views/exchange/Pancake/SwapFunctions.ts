...
export const FACTORY_ADDRESS = '0x6df2384a27FC0c96ac4a3160aED0531786227054'
export enum ChainId {
  MAINNET = 56,
  TESTNET = 97
}
...
export const FACTORY_ADDRESS_MAP = {
  ...
  [ChainId.TESTNET]: '0x6df2384a27FC0c96ac4a3160aED0531786227054'
}

export const INIT_CODE_HASH = '0x79d3005c748e149234777442cd2bbc81dd536e8c54f0f12ef5501094f700b272'

export const INIT_CODE_HASH_MAP = {
  [ChainId.MAINNET]: INIT_CODE_HASH,
  [ChainId.TESTNET]: '0x79d3005c748e149234777442cd2bbc81dd536e8c54f0f12ef5501094f700b272'
}
...
function wrappedAmount(currencyAmount: CurrencyAmount, chainId: ChainId): TokenAmount {
  console.log(currencyAmount.currency,'currencyAmount.currencycurrencyAmount.currency',currencyAmount)
...
export class Trade {
  ...
  public static bestTradeExactIn(
    ...
    console.log('9999999999AAA')
    invariant(pairs.length > 0, 'PAIRS')
    console.log('9999999999BBBB')
    invariant(maxHops > 0, 'MAX_HOPS')
    console.log('9999999999DDDD')
    invariant(originalAmountIn === currencyAmountIn || currentPairs.length > 0, 'INVALID_RECURSION')
    console.log('9999999999YYYYYY', currencyAmountIn )
    console.log('9999999999YYYYYYA', currencyOut)
    const chainId: ChainId | undefined =
      currencyAmountIn instanceof TokenAmount
        ...
        ? currencyOut.chainId
        : undefined
        console.log('9999999999ZZZZZZ',chainId)
    invariant(chainId !== undefined, 'CHAIN_ID')
    console.log('9999999999FFFFFF')
    const amountIn = wrappedAmount(currencyAmountIn, chainId)
    console.log('9999999999GGGGGG')
    const tokenOut = wrappedCurrency(currencyOut, chainId)
    console.log('9999999999HHHHHHH')
