            ...
            <div className="container">
              <GridContainer>
                <GridItem md={12} data-aos="fade-up" data-aos-duration="2000">
                  <h2>FAQ</h2>
                  <p>
                    This FAQ page answers some of the more commonly asked
                    questions from the SoldaitSwap community
                  </p>
                </GridItem>
              </GridContainer>
            </div>
                    ...
                    return (
                      <div class="card">
                        ...
                        <div
                          ...
                          class={
                            showclss == index &&
                            collapseclss == "btn btn-header-link"
                              ? "collapse show"
                              : "collapse"
                          }
                        ...
                        >
                          <div class="card-body">
                            <ul>{item && item.answer ? item.answer : ""}</ul>
                          </div>
                        </div>
                      </div>
                    );
